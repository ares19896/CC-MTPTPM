...
@section('content')
    ...
    <h3 class="panel-title">
      ...
      <span class="glyphicon glyphicon-chevron-right" style="font-size: 11px;"></span><a href="{!!url('/keo')!!}" title=""> Kẹo</a><!-- fix -->
        ...
        @foreach($keo as $row)<!-- Fix -->
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding">
            <div class="thumbnail mobile">              
              ...
              <div class="ct">
                <a href="{!!url('keo/'.$row->id.'-'.$row->slug)!!}" title="Chi tiết"><!-- Fix -->
